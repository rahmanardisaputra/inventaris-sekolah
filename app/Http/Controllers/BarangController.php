...
class BarangController extends Controller
{
    ...
    {
        // Ambil semua barang beserta relasi lokasinya
        $barangs = BarangInventaris::with('lokasi')->orderBy('created_at', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            'kode_aset' => 'required|unique:barang_inventaris,kode_aset',
        ...
        // Set default status validasi ke 'pending' karena butuh persetujuan Waka
        $validated['status_validasi'] = 'pending';
        $validated['kondisi_terkini'] = 'Baik';
